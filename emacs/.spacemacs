  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link add-node-modules-path afternoon-theme aggressive-indent alect-themes
                ...
                birds-of-paradise-plus-theme bubbleberry-theme bui busybee-theme
                centered-cursor-mode cherry-blossom-theme chocolate-theme
                clean-aindent-mode clues-theme code-review
                color-theme-sanityinc-solarized color-theme-sanityinc-tomorrow
                column-enforce-mode company-web cyberpunk-theme dakrone-theme
                dap-mode darkmine-theme darkokai-theme darktooth-theme define-word
                devdocs diminish dired-quick-sort disable-mouse django-theme
                ...
                gandalf-theme ggtags gh-md git-link git-messenger git-modes
                git-timemachine gitignore-templates golden-ratio google-translate
                gotham-theme grandshell-theme grizzl gruber-darker-theme
                ...
                helm-purpose helm-swoop helm-xref hemisu-theme heroku-theme
                hide-comnt highlight-indentation highlight-numbers
                highlight-parentheses hl-todo holy-mode hungry-delete hybrid-mode
                impatient-mode import-js indent-guide info+ inkpot-theme inspector
                ir-black-theme jazz-theme jbeans-theme js-doc js2-mode
                js2-refactor kaolin-themes light-soap-theme link-hint livid-mode
                lorem-ipsum lsp-docker lsp-origami lsp-treemacs lsp-ui lush-theme
                macrostep madhat2r-theme markdown-toc material-theme minimal-theme
                modus-themes moe-theme molokai-theme monochrome-theme
                monokai-theme multi-line multi-term multi-vterm multiple-cursors
                mustang-theme mwim nameless naquadah-theme noctilux-theme
                nodejs-repl npm-mode obsidian-theme occidental-theme oldlace-theme
                ...
                phoenix-dark-pink-theme php-auto-yasnippets phpunit planet-theme
                popwin prettier-js professional-theme pug-mode purple-haze-theme
                quickrun railscasts-theme rainbow-delimiters rebecca-theme
                restart-emacs reverse-theme sass-mode scss-mode seti-theme
                shell-pop skewer-mode slim-mode smeargle smyx-theme
                ...
                symon tagedit tango-2-theme tango-plus-theme tangotango-theme
                tao-theme term-cursor terminal-here tern toc-org toxi-theme
                ...
                volatile-highlights vterm vundo web-beautify web-mode wgrep
                white-sand-theme winum writeroom-mode ws-butler yasnippet-snippets
   ...
   '(spacemacs-theme-custom-colors
     '((base . "#ffffff") (bg1 . "#282a36") (cblk-ln-bg . "#ffffff")
       (comment . "#6272a4") (comment-bg . "#282a36") (func . "#50fa7b")
       (head3-bg . "#ffffff") (keyword . "#ff79c6") (mat . "#ffffff")
       (meta . "#86dc2f") (str . "#f1fa8c") (type . "#8be9fd") (var . "#7590db"))))
  (custom-set-faces
